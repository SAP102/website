                            ...
                            <div className="shadow sm:rounded-md sm:overflow-hidden">
                                <div className="px-4 py-5 bg-white space-y-6 sm:p-6">
                                    ...
                                    <div>
                                        ...
                                        <input type="text" onChange={handleData} value={products.Company} name="Company" id="Company"  className="mt-1 focus:ring-indigo-500 p-2 focus:border-indigo-500 block w-full shadow-sm sm:text-xl border-gray-300 rounded-md" />
                                    </div>
                                    <div>
                                                ...
                                                <div className="">
                                                    <div className="">
                                                        ...
                                                        <div className="flex text-xl text-gray-600">
                                                            ...
                                                            <input id="file-upload" name="file-upload" type="file" onChange={handlechang} className="s-only" />
                                                        </div>
                                                    </div>
                                                </div>
                                            </label>
                                ...
                                <div className="px-4 py-3 bg-gray-50 text-right sm:px-6">
                                    <button type="submit" onClick={handleProduct} className="inline-flex justify-center w-full py-3 mb-3  px-4 border border-transparent shadow-sm text-xl font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                                        Submit
                                    </button>
                                    <ToastContainer />
                                </div>
